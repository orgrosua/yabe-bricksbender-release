 ...
 */
namespace _YabeBricksbender\Composer;

use _YabeBricksbender\Composer\Autoload\ClassLoader;
use _YabeBricksbender\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_YabeBricksbender\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
